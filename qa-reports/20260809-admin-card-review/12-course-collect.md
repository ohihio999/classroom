...
- **卡片 ID：** `course-collect`
- **正式站：** https://my-teaching-tools-2b36c.web.app/admin/
- **本機來源：** `C:\Users\admin\Desktop\classroom\tools\admin\index.html:659`
- **動作：** `modal` → `openCourseCollect`
- **問題等級：** 低
- **分類：** 內容

## 1. 結論

「歸檔」太泛，使用者需點開才知道是課程散檔；skill 名稱佔據主標題。

## 2. 實際檢查證據

Modal 函式與歸檔流程說明存在，目標路徑為 `D:\2026_已整理課程`。
...
|---|---|---|
| 標題 | 歸檔（course-collect） | 課程散檔歸檔 |
| 說明 | 課程散檔收齊改名，搬進 D:\2026_已整理課程 | 收齊課程檔案、統一命名後歸檔到 D:\2026_已整理課程 |
| 連結／入口 | `openCourseCollect` | `openCourseCollect` |
...
可在 Modal 加檔案角色檢核：筆記、逐字稿、摘要／培訓報告、心智圖。
