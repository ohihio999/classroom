...
- **卡片 ID：** `video-progress`
- **正式站：** https://my-teaching-tools-2b36c.web.app/admin/
- **本機來源：** `C:\Users\admin\Desktop\classroom\tools\admin\index.html:662`
- **動作：** `link` → `/影片進度表/`
- **問題等級：** 低
- **分類：** 內容
...
原文只說「9 個步驟橫向顯示」，沒有說可追蹤狀態與連結。

## 2. 實際檢查證據

正式站 `/影片進度表/` HTTP 200；頁面具新增集數、待完成／進行中／已完成狀態與連結管理。
...
|---|---|---|
| 標題 | 影片進度表 | 影片製作進度表 |
| 說明 | 追蹤影片製作進度，9 個步驟橫向顯示 | 依 9 個階段追蹤每支影片的狀態、進度與連結 |
| 連結／入口 | `/影片進度表/` | `/影片進度表/` |
...
可在 admin 卡片顯示進行中影片數，但需讀取資料來源，未納入本次。
